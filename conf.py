...
htmlhelp_basename = 'HelioPythonTutorialsdoc'
...
latex_documents = [
    (master_doc, 'HelioPythonTutorials.tex', 'HelioPython Tutorials Documentation',
     'HelioPython', 'manual'),
]
...
man_pages = [
    (master_doc, 'heliopythontutorials', 'HelioPython Tutorials Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HelioPythonTutorials', 'HelioPython Tutorials Documentation',
     author, 'HelioPythonTutorials', 'One line description of project.',
     'Miscellaneous'),
]
